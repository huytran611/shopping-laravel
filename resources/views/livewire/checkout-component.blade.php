        ...
        <form wire:submit.prevent = "placeOrder">
          <div class="row">
            ...
            <div class="col-50">
              ...
              @error('paymentmethod') <h4>{{$message}}</h4> @enderror
              </div>
