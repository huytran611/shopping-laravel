...
<body>
    <form action="/users/create" method="post">
        @csrf
        <h2 style="text-align: center; margin-top:50px;">Đăng ký tài khoản</h2>
            <div class="container">
                <label for="fname"><b>Tên bạn</b></label>
                <input type="text" placeholder="Nhập tên của bạn" name="uname" required>

            <label for="uname"><b>Tên tài khoản</b></label>
            <input type="text" placeholder="Nhập tên tài khoản của bạn" name="name" required>
